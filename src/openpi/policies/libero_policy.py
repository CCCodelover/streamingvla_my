    ...
    def __call__(self, data: dict) -> dict:
        ...
        inputs = {
            ...
            "image_mask": {
                ...
                "right_wrist_0_rgb": np.False_, # We do not support pi0-FAST for Libero.
            },
        }
        ...
        if "observation/action_states" in data:
            ...
            inputs["action_states"] = None

        if "observation/action_left_sum" in data:
            inputs["action_left_sum"] = data["observation/action_left_sum"]
        else:
            inputs["action_left_sum"] = None
        if "observation/threshold" in data:
